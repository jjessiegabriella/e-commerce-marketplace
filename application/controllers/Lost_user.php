		...
		if($this->input->post('submit',TRUE)=='Submit')
		{
			...
			if($this->form_validation->run()==TRUE)
			{
				...
				if($get ->num_rows()>0)
				{
					...
					$this->email->message(
						'Apakah Anda lupa dengan password anda? silahkakn klik <a href="'.base_url().'lost_user/reset/'.$key.'">disini</a>. Jika anda tidak merasa request fitur ini, silahkan abaikan pesan ini'
					);
