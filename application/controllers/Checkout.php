		...
		if ($this->input->post('submit', TRUE) == 'Submit')
      {
         ...
         if ($this->form_validation->run() == TRUE)
         {
            ...
            if ($get->num_rows() > 0)
            {
               ...
               $config['smtp_user'] = 'jesigabriella@gmail.com';
               $config['smtp_pass'] = 'Silalahi10012000'; 
               $config['crlf'] = "\r\n";
               $config['newline'] = "\r\n";
               ...
               $this->email->from('jesigabriella@gmail.com', "Olshopku");
               $this->email->to($user->email);
               $this->email->subject('Pembayaran');
               $this->email->message(
                  'Terima Kasih telah melakukan pemesanan di toko kami, selanjutnya silahkan anda mentransfer uang senilai <b>Rp. '.number_format($total, 0, ',', '.').',-</b> ke no. rekening <b>9087654345565</b> paling lambat '.$bts.' agar pesanan anda bisa kami proses. Detail pembayaran sebagai berikut :<br/><br/>
