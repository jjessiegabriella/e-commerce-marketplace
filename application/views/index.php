...
<html>
   ...
   <body>
      ...
      <main>
         <div class="toko">
            <h2><a href="<?= base_url(); ?>"><i class="fa fa-shopping-cart"></i>Reebonz</a></h2>
         ...
         <div class="cont">
            ...
            <footer class="page-footer light-blue darken-3">
               <div class="container">
                  <div class="row">
                     <div class="col l6 s12">
                        ...
                        <p class="grey-text text-lighten-4">Jl.Alumni No. 3 Fasilkom-TI Medan,Indonesia.<br /><i class="fa fa-phone-square"></i> 0811-7671-121</p>
                     </div>
                     <div class="col l5 offset-l1 s12">
                        <h5 class="white-text">Find Us</h5>
                        <div class="link">
                           <a class="grey-text text-lighten-3" href="#!"><i class="fa fa-facebook"></i> Reebonz</a>&nbsp;&nbsp;
                           <a class="grey-text text-lighten-3" href="#!"><i class="fa fa-twitter"></i> @Reebonz</a>&nbsp;&nbsp;
                           <a class="grey-text text-lighten-3" href="#!"><i class="fa fa-google-plus"></i> Reebonz+</a>
                        </div>
                     </div>
                  </div>
               </div>
               <div class="footer-copyright">
                  <div class="container">
                     Copyright © 2018 Reebonz. All Rights Reserved.
                     <span class="grey-text text-lighten-4 right">Develope By <a class="blue-text text-lighten-4" href="https://kangjaz.blogspot.co.id/">Group 10</a></span>
                  </div>
               </div>
            </footer>
         </div>
