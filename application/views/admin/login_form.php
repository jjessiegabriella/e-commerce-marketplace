...
<html lang="en">
   ...
   <body>
      <div class="container">
         <center>
            <span class="header"><i class="fa fa-shopping-cart"></i> Reebonz</span>
         </center>
         <div class="col-md-4 col-sm-12 col-md-offset-4">
            ...
            <p style="color:white">Lupa dengan password anda ? Silahkan klik <a href="<?= base_url(); ?>lost_admin">disini</a></p>
         </div>
      </div>
      <!-- jQuery -->
